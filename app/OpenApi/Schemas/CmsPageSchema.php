...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'image_url', type: 'string', nullable: true, description: "URL publique absolue de l'image de couverture, ou null."),
        new OA\Property(property: 'images', type: 'array', nullable: true, description: "Galerie d'images complémentaires (chargée sur `GET /cms/pages/{slug}` et pour les gestionnaires CMS).", items: new OA\Items(ref: '#/components/schemas/CmsPageImage')),
