...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('users/{user}/payment-proof-document', [UserController::class, 'paymentProofDocument'])->middleware('permission:users.manage');
    ...
    Route::post('scholarships', [ScholarshipController::class, 'store'])->middleware('permission:cms.manage');
    Route::patch('scholarships/{scholarship}', [ScholarshipController::class, 'update'])->middleware('permission:cms.manage');
    Route::delete('scholarships/{scholarship}', [ScholarshipController::class, 'destroy'])->middleware('permission:cms.manage');
